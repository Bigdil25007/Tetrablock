...
public static class Data
{
    ...
    // Définition des "wall kicks" pour le tétrimino I (ajustements lors de la rotation près des murs).
    ...
    // Définition des "wall kicks" pour les autres tétriminos (J, L, O, S, T, Z).
    private static readonly Vector2Int[,] WallKicksJLOSTZ = new Vector2Int[,] {
        // Comme pour WallKicksI, mais ces ajustements sont utilisés pour les autres tétriminos.
    ...
    // Dictionnaire global des "wall kicks" pour chaque type de tétrimino.
    public static readonly Dictionary<Tetromino, Vector2Int[,]> WallKicks = new Dictionary<Tetromino, Vector2Int[,]>()
    {
        // Assignation des matrices de "wall kicks" pour chaque type de tétrimino.
